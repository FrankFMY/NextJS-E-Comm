...
export default function CartIcon() {
  ...
  return (
    <Link 
      href="/cart" 
      className="header-link relative flex items-center px-4 py-2 rounded transition-colors font-medium"
    >
      <svg 
      ...
      {/* Only show the cart count badge after client-side hydration is complete and cart is loaded */}
